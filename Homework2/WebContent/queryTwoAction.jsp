...
<html>
	...
	<body>
		...
		<h3 align="center">
			Successfully updated the nurse table.
		</h3>
		<h3 align="center">
		...
		<div align="center">
			<p>&nbsp;</p>
				<%
					...
					{
						rset = handler.queryTwo(Integer.parseInt(request.getParameter("eid")),
						Integer.parseInt(request.getParameter("salary")),
						request.getParameter("e_sex"),
						request.getParameter("e_name"),
						request.getParameter("e_contact_no"),
						request.getParameter("street"),
						request.getParameter("city"),
						request.getParameter("state"),
						Integer.parseInt(request.getParameter("zipcode")),
						Integer.parseInt(request.getParameter("nurse_level")));
