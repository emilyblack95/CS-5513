...
<html>
	...
	<body>
		...
		<h3 align="center">
			Successfully updated the patient table.
		</h3>
		<h3 align="center">
		...
		<div align="center">
			<p>&nbsp;</p>
				<%
					...
					{
						rset = handler.queryOne(Integer.parseInt(request.getParameter("pid")),
						request.getParameter("p_name"),
						request.getParameter("p_sex"),
						request.getParameter("address"),
						request.getParameter("d_day"),
						request.getParameter("d_month"),
						request.getParameter("d_year"),
						request.getParameter("a_day"),
						request.getParameter("a_month"),
						request.getParameter("a_year"),
						request.getParameter("contacts").split(","));
