...
<html>
	...
	<body>
		...
		<h3 align="center">
			All the doctors who care for more than N patients (e.g. 2).
		</h3>
		<h3 align="center">
			<jsp:useBean id="empsbean" class="CS5513.DataHandler" scope="session"/>
		</h3>
		<form action="querySevenAction.jsp">
			<div align="center">
				<p>&nbsp;</p>
				<table cellspacing="2" cellpadding="3" border="1" width="369">
					<tr>
						...
						<td width="62%">
							<input type="text" name="n_patients"/>
						</td>
					</tr>
				</table>
				<table cellspacing="3" cellpadding="2" border="0">
					<tr>
						<td>
							<input type="submit" name="insertbutton" value="Find Doctor(s)"/>
						</td>
						<td>
